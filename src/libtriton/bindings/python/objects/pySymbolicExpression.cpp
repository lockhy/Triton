  ...
  namespace bindings {
    namespace python {
      ...
      PyTypeObject SymbolicExpression_Type = {
        ...
        0,                                          /* tp_descr_set */
        0,                                          /* tp_dictoffset */
        0,//(initproc)SymbolicExpression_init,          /* tp_init */
        0,                                          /* tp_alloc */
        0,//(newfunc)SymbolicExpression_new,            /* tp_new */
        0,                                          /* tp_free */
        0,                                          /* tp_is_gc */
        0,                                          /* tp_bases */
        0,                                          /* tp_mro */
      ...
      PyObject* PySymbolicExpression(const triton::engines::symbolic::SharedSymbolicExpression& symExpr) {
        ...
        if (object != NULL) {
          new (&object->symExpr) std::shared_ptr<triton::engines::symbolic::SymbolicExpression>();
          object->symExpr = symExpr;
        }
